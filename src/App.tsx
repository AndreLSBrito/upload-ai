  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        <h1 className="texte-xl font-bold">Upload.ai</h1>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembre-se: você pode usar a variável <code className='text-violet-400'>{'{transcription}'}</code>  no seu prompt para adiocionar o conteúdo da transcrição no vídeo selecionado.</p>
        </div>
